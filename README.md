...
![](https://media.giphy.com/media/SggXTju3QIs9aLRiTK/giphy.gif)
![](https://media.giphy.com/media/FQzYT3rpPAyrnyBk64/giphy.gif)
...
**I would've tried working on creating a backend for user accounts and information**
...
**Shoutout to Moe, he helped me discover a lot of bugs that I had spent hours on. Shoutout to Ammar (fellow intern). He really helped me out with connecting the backend to the frontend of the project**
